...
#==============================================================================
def with_postgresql_transactions(cls):
    """a class decorator for Crontabber Apps.  This decorator will give access
    to a postgres connection source.  Configuration will be automatically set
    up and the cron app can expect to have attributes _database and
    _database_transaction available to use.
    """
    ...
    #==========================================================================
    class PostgresResourcesMixin(cls):
        required_config = Namespace()
        ...
        def __init__(self, *args, **kwargs):
            super(PostgresResourcesMixin, self).__init__(*args, **kwargs)
            self._database = self.config.database_class(
    ...
    return PostgresResourcesMixin


#==============================================================================
def with_postgresql_connection_as_argument(cls):
...
#==============================================================================
def with_single_transaction(cls):
    ...
    class SingleTransactionMixin(cls):
        #----------------------------------------------------------------------
        def _run_proxy(self, *args, **kwargs):
            self._database_transaction(self.run, *args, **kwargs)
...
# convenience classes
#
# a selection of classes predefined with various combinations of mixins.
# these classes are for the currently defined CronApp's
...
class BaseBackfillCronApp(BaseCronApp):
    """a base for backfil cron apps"""


#==============================================================================
@with_postgresql_transactions
@with_postgresql_connection_as_argument
...
@with_postgresql_connection_as_argument
@as_backfill_cron_app
class PostgresBackfillCronApp(BaseCronApp):
