...
from socorro.external.postgresql.webservice_base import (
...
class LagLog(PostgreSQLWebServiceBase):
    ...
    def get(self, **kwargs):
        ...
        max_bytes_critical = self.context.max_bytes_critical
        max_bytes_warning = self.context.max_bytes_warning
