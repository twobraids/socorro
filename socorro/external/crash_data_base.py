    ...
    def get(self, **kwargs):
        ...
        try:
            ...
            if params.datatype in ('processed', 'unredacted'):
                ...
                # the following section of code will be replaced when the
                # service discovery is implemented - yes
                # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                priority_job_service = Priorityjobs(
                    config=self.config
                )
                priority_job_service.create(uuid=params.uuid)
                # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                # this will be the replacement section of code for the
                # previous section
                # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
