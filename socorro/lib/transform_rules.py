    ...
    def __init__(self, predicate,
        ...
        input parameters:
            pedicate - the name of a function to serve as a predicate.  The
                       ...
                       'predicate' with the aforemention charactistics
        ...
        if inspect.isclass(self.predicate):
            ...
            # function to the objects 'predicate' method
        ...
        if inspect.isclass(self.action):
            # the action is actually a class, go on an instantiate it, then
            ...
            if self._predicitate_implementation.__class__ is self.action:
                ...
                # class, only instantiation one copy.
