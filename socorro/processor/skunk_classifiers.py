...
class DontConsiderTheseFilter(SkunkClassificationRule):
    ...
    def predicate(self, raw_crash,  processed_crash, processor):
        ...
        try:
            ...
            # we can
            if raw_crash.process_type != 'plugin':
            ...
            try:
                if processed_crash.json_dump.cpu_arch == 'amd64':
                    processor.config.logger.debug(
...
default_classifier_rules = (
    (DontConsiderTheseFilter, None, None, DontConsiderTheseFilter, None, None),
    (UpdateWindowAttributes, None, None, UpdateWindowAttributes, None, None),
    (SetWindowPos, None, None, SetWindowPos, None, None),
    (SendWaitReceivePort, None, None, SendWaitReceivePort, None, None),
    (Bug811804, None, None, Bug811804, None, None),
    (Bug812318, None, None, Bug812318, None, None),
)
