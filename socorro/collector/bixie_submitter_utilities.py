...
class BixieGETDestination(CrashStorageBase):
    ...
    def save_raw_crash(self, raw_crash, dumps, crash_id):
        ...
        crash_to_submit['sentry_version'] = raw_crash.get('sentry_version','')
        crash_to_submit['sentry_client'] = raw_crash.get('sentry_client', '')
        crash_to_submit['sentry_key'] = raw_crash.get('sentry_key', '')
        crash_to_submit['sentry_data'] = json.dumps(
            raw_crash.get('sentry_data', {})
        )
