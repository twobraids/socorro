...
class ApplicationDefaultsProxy(object):
    ...
    def find_all_the_apps():
        ...
        return {
            ...
            #'SocorroWelcomeApp': 'socorro.app.socorro_app.SocorroWelcomeApp',
        }
...
class ValueSource(object):
    ...
    The end result is that an app that has a perfered set of defaults can still
