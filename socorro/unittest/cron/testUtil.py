...
#class TestUtil(unittest.TestCase):
  ...
  #def testGetProcessingDates(self):
    ...
    #start = datetime.datetime(2000,1,2,12,12,tzinfo=utctz)
  ...
  #def testGetProcessingWindow(self):
    ...
    #procStart = datetime.datetime(2001,9,8,tzinfo=utctz)
    ...
    #extraProcDay = datetime.datetime(2001,9,8,7,6,5,tzinfo=utctz)
    ...
    #otherProcDay = datetime.datetime(2003,9,8,7,6,5,tzinfo=utctz)
  ...
  #def testGetLastWindowAndSizeFromTable(self):
    ...
    #end = datetime.datetime(2001,2,3,12,tzinfo=utctz)
  ...
  #def testGetDefaultDateInterval(self):
    ...
    #end0 = datetime.datetime(2008,12,11,10,tzinfo=utctz)
