...
from socorro.external.postgresql.backfill_webservice import BackfillWebService
...
class TestBackfill(PostgreSQLTestCase):
    ...
    def setUp(self):
        ...
        super(TestBackfill, self).setUp(BackfillWebService)
   ...
   #--------------------------------------------------------------------------
    def test_get(self):
        ...
        backfill = BackfillWebService(config=self.config)
