...
from socorro.external.postgresql.server_status_webservice import ServerStatus
...
import socorro
_socorro_base_directory = os.path.dirname(socorro.__file__)
...
class IntegrationTestServerStatus(PostgreSQLTestCase):
    """Test socorro.external.postgresql.server_status_webservice.ServerStatus
    class. """
    ...
    def setUp(self):
        ...
        self.basedir = _socorro_base_directory
