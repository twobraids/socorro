...
from socorro.external.postgresql.bugs_impl import Bugs, execute_query_fetchall
...
class TestBugsImpl(TestCase):
    ...
    def test_signatures(self):
        ...
        expected_return_value = expected_transaction_object.return_value
        ...
        eq_(b.transaction, expected_transaction_object)
        b.transaction.assert_called_once_with(
            execute_query_fetchall,
            b.signatures_sql,
            ('123456',)
        )
        eq_(result, expected_return_value)
    ...
    def test_action_signatures(self):
        ...
        # the call to be tested
        result = b.action('signatures', '123456')
        eq_(result, expected_result)

    #--------------------------------------------------------------------------
    def test_action_bug_ids(self):
        config = self.get_basic_config()
        expected_transaction_object = (
            config.crashstorage_class.return_value.transaction
        )
        ...
        # the call to be tested
        result = b.action('bug_ids', '123456')
        eq_(result, expected_result)
