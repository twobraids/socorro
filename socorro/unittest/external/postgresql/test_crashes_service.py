...
from socorro.external.postgresql.crashes_webservice import Crashes
...
from socorro.external.postgresql.util_webservice import Util
...
class TestCrashes(TestCase):
    ...
    #--------------------------------------------------------------------------
    # TODO:  this needs to be replaced with the current standard
    def get_dummy_config(self):
        ...
        #config['services.Crashes'] = DotDictWithAcquisition({
            ...
            #'redactor_class': Mock(),
        #})
        #config.services['Util'] = DotDictWithAcquisition({
            #'database_hostname': 'somewhere',
            #'database_port': '8888',
            #'database_name': 'somename',
            #'database_username': 'someuser',
            ...
            #'redactor_class': Mock(),
        #})
        #config.services.Crashes['platforms'] = (
            #{
                #"id": "windows",
                #"name": "Windows NT"
            #},
            ...
            #}
        #)
        #config['services.Crashes.non_release_channels'] = [
            #'beta', 'aurora', 'nightly'
        #]
        #config['services.Crashes.restricted_channels'] = [
            #'beta'
        #]
