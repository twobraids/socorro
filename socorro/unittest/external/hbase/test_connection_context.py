...
class TestConnectionContext(unittest.TestCase):
    ...
    def test_basic_hbase_usage(self):
        ...
        with mock.patch(mock_hbcl_str) as mocked_hbcl:
            ...
            self.assertEqual(
                a_fake_hbase_connection._close_counter,
                1
            )
            # open a connection
    ...
    def test_hbase_usage_with_transaction(self):
        ...
        with mock.patch(mock_hbcl_str) as mocked_hbcl:
            ...
            self.assertEqual(
                a_fake_hbase_connection._rollback_counter,
                0
            )
            self.assertEqual(
                a_fake_hbase_connection._commit_counter,
                1
            )
