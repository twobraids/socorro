...
from socorro.external.elasticsearch.service_base import ElasticSearchBase
...
class IntegrationTestElasticSearchBase(TestCase):
    ...
    def _get_default_config(self):
        overrides = {
            'resource.elasticsearch.elasticSearchHostname': 'somehost',
    ...
    #--------------------------------------------------------------------------
    @mock.patch('socorro.external.elasticsearch.service_base.httpc')
