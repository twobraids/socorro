...
from socorro.external.postgresql.signature_urls_webservice import SignatureURLs
...
class IntegrationTestSignatureURLs(PostgreSQLTestCase):
    """Test socorro.external.postgresql.signature_urls_webservice.SignatureURLs
    class. """
