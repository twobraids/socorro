...
class TestBreakpadTransformRule(TestCase):
    ...
    def test_everything_we_hoped_for(self):
        ...
        with patch(
            'socorro.processor.breakpad_transform_rules.subprocess'
        ) as mocked_subprocess_module:
    ...
    #--------------------------------------------------------------------------
    def test_stackwalker_fails(self):
        config = self.get_basic_config()
    ...
    #--------------------------------------------------------------------------
    def test_stackwalker_fails_2(self):
        config = self.get_basic_config()
    ...
    def test_temp_file_context(self):
        ...
        with patch(
            'socorro.processor.breakpad_transform_rules.os.unlink'
        ) as mocked_unlink:
